...
public class CabinetVariantBlockEntity extends LockableBlockEntity implements MinimalSidedInventory, SidedInventory, BlockEntityExtraListener {
    ...
    private final ViewerCountManager stateManager = new ViewerCountManager() {
        ...
        protected boolean isPlayerViewing(PlayerEntity player) {
            if (player.currentScreenHandler instanceof GenericContainerScreenHandler) {
                return ((GenericContainerScreenHandler) player.currentScreenHandler).getInventory() == CabinetVariantBlockEntity.this;
            }
            return false;
        }
    };
    ...
    private class Gui extends LedgerSimpleGui {
        public Gui(ServerPlayerEntity player) {
            ...
            for (int i = 0; i < 27; i++) {
                this.setSlotRedirect(i, new LedgerSlot(pos, player, CabinetVariantBlockEntity.this, 1, 1, i));
            }
            this.open();
        }
