...
import com.phoen1x.block.DrawerBooksBlock;
...
public class DrawerBooksBlockEntity extends LockableBlockEntity implements MinimalSidedInventory, SidedInventory, BlockEntityExtraListener {
    ...
    private DrawerBooksBlock.Model model;

    public DrawerBooksBlockEntity(BlockPos pos, BlockState state) {
        super(ModEntities.DRAWER_BOOKS, pos, state);
    }
    ...
    public static <T extends BlockEntity> void tick(World world, BlockPos pos, BlockState state, T t) {
        if (t instanceof DrawerBooksBlockEntity entity) {
    ...
    private final ViewerCountManager stateManager = new ViewerCountManager() {
        ...
        protected void onContainerOpen(World world, BlockPos pos, BlockState state) {
            DrawerBooksBlockEntity.this.playSound(state, SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN);
            DrawerBooksBlockEntity.this.setOpen(state, true);
        }

        @Override
        protected void onContainerClose(World world, BlockPos pos, BlockState state) {
            DrawerBooksBlockEntity.this.playSound(state, SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE);
    ...
    void setOpen(BlockState state, boolean open) {
        this.world.setBlockState(this.getPos(), state.with(DrawerBooksBlock.OPEN, open), 3);
    }
    ...
    private class Gui extends LedgerSimpleGui {
        ...
        @Override
        public void onTick() {
            if (player.getPos().squaredDistanceTo(Vec3d.ofCenter(DrawerBooksBlockEntity.this.pos)) > (18 * 18)) {
                this.close();
            }
            super.onTick();
        }
