...
import com.phoen1x.block.entity.SmallDrawersBlockEntity;
...
public class SmallDrawersBlock extends BlockWithEntity implements FactoryBlock, InventoryProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return SmallDrawersBlockEntity::tick;
    }

    @Override
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!player.isSneaking() && world.getBlockEntity(pos) instanceof SmallDrawersBlockEntity entity) {
    ...
    public static class Model extends BlockModel {
        ...
        private final ItemDisplayElement small_drawers;
        ...
        public Model(BlockState state, ServerWorld world, BlockPos pos, Identifier blockId) {
            ...
            this.small_drawers = state.get(OPEN) ? ItemDisplayElementUtil.createSimple(OPEN_TRUE) : ItemDisplayElementUtil.createSimple(OPEN_FALSE);
            this.small_drawers.setScale(new Vector3f(2.0f));
            this.updateStatePos(state);
            this.addElement(small_drawers);
        }

        private void updateStatePos(BlockState state) {
            var direction = state.get(FACING);
            var yaw = direction.getPositiveHorizontalDegrees();
            this.small_drawers.setYaw(yaw);
        ...
        private void updateBookshelfModel(BlockState state) {
            ...
            this.small_drawers.setItem(newModel);
            this.small_drawers.tick();
        }
