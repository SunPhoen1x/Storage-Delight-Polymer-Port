...
import com.phoen1x.block.entity.DrawerDoorBlockEntity;
...
public class DrawerDoorBlock extends BlockWithEntity implements FactoryBlock, InventoryProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return DrawerDoorBlockEntity::tick;
    }

    @Override
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (!player.isSneaking() && world.getBlockEntity(pos) instanceof DrawerDoorBlockEntity entity) {
