...
public class BlockEntityTypesRegistry {
    public static final BlockEntityType<BookshelfDoorBlockEntity> BOOKSHELF_DOOR = register("bookshelf_door", FabricBlockEntityTypeBuilder.create(BookshelfDoorBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<CabinetVariantBlockEntity> CABINET_VARIANT  = register("cabinet_variant", FabricBlockEntityTypeBuilder.create(CabinetVariantBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<DrawerBlockEntity> DRAWER = register("drawer", FabricBlockEntityTypeBuilder.create(DrawerBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<DrawerDoorBlockEntity> DRAWER_DOOR  = register("drawer_door", FabricBlockEntityTypeBuilder.create(DrawerDoorBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<DrawerBooksBlockEntity> DRAWER_BOOKS  = register("drawer_books", FabricBlockEntityTypeBuilder.create(DrawerBooksBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<SmallDrawersBlockEntity> SMALL_DRAWERS  = register("small_drawers", FabricBlockEntityTypeBuilder.create(SmallDrawersBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
    ...
    public static final BlockEntityType<GlassCabinetBlockEntity> GLASS_CABINET  = register("glass_cabinet", FabricBlockEntityTypeBuilder.create(GlassCabinetBlockEntity::new,                             BlockRegistry.OAK_BOOKSHELF_WITH_DOOR,
