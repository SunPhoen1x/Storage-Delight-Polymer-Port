...
public class BlockRegistry {
    ...
    public static void registerBlocks() {
        ...
        builder.entries((displayContext, entries) -> {
            ...
            entries.add(BlockRegistry.OAK_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_OAK_DRAWERS_ITEM);
            entries.add(BlockRegistry.OAK_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_OAK_CABINET_ITEM);
            entries.add(BlockRegistry.OAK_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.OAK_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.BIRCH_DRAWER_ITEM);
            entries.add(BlockRegistry.BIRCH_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.BIRCH_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_BIRCH_DRAWERS_ITEM);
            entries.add(BlockRegistry.BIRCH_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_BIRCH_CABINET_ITEM);
            entries.add(BlockRegistry.BIRCH_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.BIRCH_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.SPRUCE_DRAWER_ITEM);
            entries.add(BlockRegistry.SPRUCE_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.SPRUCE_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_SPRUCE_DRAWERS_ITEM);
            entries.add(BlockRegistry.SPRUCE_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_SPRUCE_CABINET_ITEM);
            entries.add(BlockRegistry.SPRUCE_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.SPRUCE_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.JUNGLE_DRAWER_ITEM);
            entries.add(BlockRegistry.JUNGLE_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.JUNGLE_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_JUNGLE_DRAWERS_ITEM);
            entries.add(BlockRegistry.JUNGLE_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_JUNGLE_CABINET_ITEM);
            entries.add(BlockRegistry.JUNGLE_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.JUNGLE_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.ACACIA_DRAWER_ITEM);
            entries.add(BlockRegistry.ACACIA_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.ACACIA_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_ACACIA_DRAWERS_ITEM);
            entries.add(BlockRegistry.ACACIA_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_ACACIA_CABINET_ITEM);
            entries.add(BlockRegistry.ACACIA_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.ACACIA_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.DARK_OAK_DRAWER_ITEM);
            entries.add(BlockRegistry.DARK_OAK_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.DARK_OAK_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_DARK_OAK_DRAWERS_ITEM);
            entries.add(BlockRegistry.DARK_OAK_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_DARK_OAK_CABINET_ITEM);
            entries.add(BlockRegistry.DARK_OAK_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.DARK_OAK_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.MANGROVE_DRAWER_ITEM);
            entries.add(BlockRegistry.MANGROVE_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.MANGROVE_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_MANGROVE_DRAWERS_ITEM);
            entries.add(BlockRegistry.MANGROVE_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_MANGROVE_CABINET_ITEM);
            entries.add(BlockRegistry.MANGROVE_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.MANGROVE_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.CHERRY_DRAWER_ITEM);
            entries.add(BlockRegistry.CHERRY_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.CHERRY_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_CHERRY_DRAWERS_ITEM);
            entries.add(BlockRegistry.CHERRY_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_CHERRY_CABINET_ITEM);
            entries.add(BlockRegistry.CHERRY_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.CHERRY_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.PALE_OAK_DRAWER_ITEM);
            entries.add(BlockRegistry.PALE_OAK_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.PALE_OAK_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_PALE_OAK_DRAWERS_ITEM);
            entries.add(BlockRegistry.PALE_OAK_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_PALE_OAK_CABINET_ITEM);
            entries.add(BlockRegistry.PALE_OAK_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.PALE_OAK_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.BAMBOO_DRAWER_ITEM);
            entries.add(BlockRegistry.BAMBOO_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.BAMBOO_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_BAMBOO_DRAWERS_ITEM);
            entries.add(BlockRegistry.BAMBOO_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_BAMBOO_CABINET_ITEM);
            entries.add(BlockRegistry.BAMBOO_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.BAMBOO_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.CRIMSON_DRAWER_ITEM);
            entries.add(BlockRegistry.CRIMSON_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.CRIMSON_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_CRIMSON_DRAWERS_ITEM);
            entries.add(BlockRegistry.CRIMSON_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_CRIMSON_CABINET_ITEM);
            entries.add(BlockRegistry.CRIMSON_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.CRIMSON_SINGLE_DOOR_CABINET_ITEM);

            entries.add(BlockRegistry.WARPED_DRAWER_ITEM);
            entries.add(BlockRegistry.WARPED_DRAWER_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.WARPED_DRAWER_WITH_BOOKS_ITEM);
            entries.add(BlockRegistry.SMALL_WARPED_DRAWERS_ITEM);
            entries.add(BlockRegistry.WARPED_BOOKSHELF_WITH_DOOR_ITEM);
            entries.add(BlockRegistry.GLASS_WARPED_CABINET_ITEM);
            entries.add(BlockRegistry.WARPED_CABINET_WITH_GLASS_DOORS_ITEM);
            entries.add(BlockRegistry.WARPED_SINGLE_DOOR_CABINET_ITEM);
        });
